  ...
  async onload() {
    ...
    this.addCommand({
      ...
      callback: () => {
        ...
        let recentFiles = files.filter((f) => start.isBefore(moment(f.stat.ctime))).sort((a, b) => (b == null ? void 0 : b.stat.ctime) - (a == null ? void 0 : a.stat.ctime));
        new import_obsidian.Notice(`Opening ${recentFiles.length} files created in the last ${this.settings.daysAgo} days.`);
